...
export function FeedbackTable({feedbackItems}: FeedbackTableProps) {
  ...
  const filteredAndSortedFeedback = useMemo(() => {
    ...
    if (searchQuery) {
      ...
      /* eslint-disable @typescript-eslint/prefer-nullish-coalescing -- Boolean OR chain for filter conditions */
      result = result.filter(f => f.comment?.toLowerCase().includes(query)
