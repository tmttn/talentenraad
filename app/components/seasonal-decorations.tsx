...
export function ChristmasLights() {
  ...
  if (!config.enabled || !config.decorations.christmasLights) {
    return null;
  }
...
export function Icicles() {
  ...
  if (!config.enabled || !config.decorations.icicles) {
    return null;
  }
...
export function Snowfall() {
  ...
  if (!config.enabled || !config.decorations.snowfall || snowflakes.length === 0) {
    return null;
  }
