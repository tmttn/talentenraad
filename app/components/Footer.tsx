        ...
        <div className="flex justify-center align-middle bg-gray-300 min-h-72">
            <footer className="py-10 footer text-base-content max-w-[1280px]">
                ...
                <nav>
                    ...
                    <a className="link link-hover">Brew with Us</a>
                    <a className="link link-hover">Join the Crew</a>
                    <a className="link link-hover">Press Beans</a>
                </nav>
                <nav>
                    <h6 className="footer-title">Legal</h6>
                    <a className="link link-hover">Brew Guidelines</a>
                    <a className="link link-hover">Privacy Blend</a>
                    <a className="link link-hover">Cookie Recipe</a>
                </nav>
                <nav>
