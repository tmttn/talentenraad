...
describe('AnimatedLink', () => {
  ...
  it('hides arrow when showArrow is false', () => {
    const {container} = render(<AnimatedLink href='/test' showArrow={false}>
      Link
    </AnimatedLink>);
    const arrow = container.querySelector('.animated-link-arrow');
  ...
  it('renders left arrow when arrowDirection is left', () => {
    const {container} = render(<AnimatedLink href='/test' arrowDirection='left'>
      Link
    </AnimatedLink>);
  ...
  describe('variants', () => {
    ...
    it('applies secondary variant', () => {
      render(<AnimatedLink href='/test' variant='secondary'>
        Link
      </AnimatedLink>);
      const link = screen.getByRole('link');
    ...
    it('applies white variant', () => {
      render(<AnimatedLink href='/test' variant='white'>
        Link
      </AnimatedLink>);
      const link = screen.getByRole('link');
    ...
    it('applies muted variant', () => {
      render(<AnimatedLink href='/test' variant='muted'>
        Link
      </AnimatedLink>);
      const link = screen.getByRole('link');
  ...
  describe('sizes', () => {
    ...
    it('applies sm size', () => {
      render(<AnimatedLink href='/test' size='sm'>
        Link
      </AnimatedLink>);
      const link = screen.getByRole('link');
    ...
    it('applies lg size', () => {
      render(<AnimatedLink href='/test' size='lg'>
        Link
      </AnimatedLink>);
      const link = screen.getByRole('link');
  ...
  describe('external links', () => {
    ...
    it('adds target and rel attributes for external links', () => {
      render(<AnimatedLink href='https://example.com' external>
        External Link
      </AnimatedLink>);
      const link = screen.getByRole('link');
  ...
  it('accepts custom className', () => {
    render(<AnimatedLink href='/test' className='custom-class'>
      Link
    </AnimatedLink>);
    const link = screen.getByRole('link');
