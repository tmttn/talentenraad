...
describe('AnnouncementDisplay', () => {
  ...
  describe('announcement types', () => {
    it('renders info type with correct styling', () => {
      const {container} = render(<AnnouncementDisplay announcement={{...baseAnnouncement, type: 'info'}} />);
    ...
    it('renders waarschuwing type with correct styling', () => {
      const {container} = render(<AnnouncementDisplay announcement={{...baseAnnouncement, type: 'waarschuwing'}} />);
    ...
    it('renders belangrijk type with correct styling', () => {
      const {container} = render(<AnnouncementDisplay announcement={{...baseAnnouncement, type: 'belangrijk'}} />);
